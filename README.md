...
services:
  client:
    image: "11notes/netbird-client:0.68.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.68.1](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.68.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.68.1
docker pull ghcr.io/11notes/netbird-client:0.68.1
docker pull quay.io/11notes/netbird-client:0.68.1
```
...
*created 09.04.2026, 08:30:18 (CET)*