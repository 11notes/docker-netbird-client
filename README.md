...
services:
  client:
    image: "11notes/netbird-client:0.71.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.71.3](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.71.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.71.3
docker pull ghcr.io/11notes/netbird-client:0.71.3
docker pull quay.io/11notes/netbird-client:0.71.3
```
...
*created 21.05.2026, 10:39:31 (CET)*