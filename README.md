...
services:
  client:
    image: "11notes/netbird-client:0.66.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.66.2](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.66.2)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.66.2
docker pull ghcr.io/11notes/netbird-client:0.66.2
docker pull quay.io/11notes/netbird-client:0.66.2
```
...
*created 05.03.2026, 06:57:41 (CET)*