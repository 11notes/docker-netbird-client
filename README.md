...
services:
  client:
    image: "11notes/netbird-client:0.68.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.68.2](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.68.2)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.68.2
docker pull ghcr.io/11notes/netbird-client:0.68.2
docker pull quay.io/11notes/netbird-client:0.68.2
```
...
*created 14.04.2026, 08:58:26 (CET)*