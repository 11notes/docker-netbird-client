...
services:
  client:
    image: "11notes/netbird-client:0.65.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.65.2](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.65.2)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.65.2
docker pull ghcr.io/11notes/netbird-client:0.65.2
docker pull quay.io/11notes/netbird-client:0.65.2
```
...
*created 18.02.2026, 07:08:48 (CET)*