...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-client | 61MB | 0:0 | ❌ | amd64, arm64, armv7 |
...
services:
  client:
    image: "11notes/netbird-client:0.65.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.65.1](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.65.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.65.1
docker pull ghcr.io/11notes/netbird-client:0.65.1
docker pull quay.io/11notes/netbird-client:0.65.1
```
...
*created 15.02.2026, 07:03:03 (CET)*