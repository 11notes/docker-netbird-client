...
services:
  client:
    image: "11notes/netbird-client:0.72.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.72.3](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.72.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.72.3
docker pull ghcr.io/11notes/netbird-client:0.72.3
docker pull quay.io/11notes/netbird-client:0.72.3
```
...
*created 11.06.2026, 11:19:33 (CET)*