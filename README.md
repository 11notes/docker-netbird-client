...
services:
  client:
    image: "11notes/netbird-client:0.64.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.64.4](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.64.4)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.64.4
docker pull ghcr.io/11notes/netbird-client:0.64.4
docker pull quay.io/11notes/netbird-client:0.64.4
```
...
*created 03.02.2026, 09:04:07 (CET)*