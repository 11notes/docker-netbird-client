...
services:
  client:
    image: "11notes/netbird-client:0.73.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.73.2](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.73.2)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.73.2
docker pull ghcr.io/11notes/netbird-client:0.73.2
docker pull quay.io/11notes/netbird-client:0.73.2
```
...
*created 23.06.2026, 10:36:36 (CET)*