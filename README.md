...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-client:0.59.8 | 30MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
...
services:
  client:
    image: "11notes/netbird-client:0.59.8"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.59.8](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.59.8)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.59.8
docker pull ghcr.io/11notes/netbird-client:0.59.8
docker pull quay.io/11notes/netbird-client:0.59.8
```
...
*created 22.10.2025, 07:29:55 (CET)*