...
services:
  client:
    image: "11notes/netbird-client:0.74.6"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.74.6](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.74.6)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.74.6
docker pull ghcr.io/11notes/netbird-client:0.74.6
docker pull quay.io/11notes/netbird-client:0.74.6
```
...
*created 16.07.2026, 09:28:24 (CET)*