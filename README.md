...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-client:0.59.11 | 30MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
...
services:
  client:
    image: "11notes/netbird-client:0.59.11"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.59.11](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.59.11)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.59.11
docker pull ghcr.io/11notes/netbird-client:0.59.11
docker pull quay.io/11notes/netbird-client:0.59.11
```
...
*created 30.10.2025, 06:28:52 (CET)*