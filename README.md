...
services:
  client:
    image: "11notes/netbird-client:0.78.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.78.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.78.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.78.0
docker pull ghcr.io/11notes/netbird-client:0.78.0
docker pull quay.io/11notes/netbird-client:0.78.0
```
...
*created 04.09.2026, 06:08:53 (CET)*