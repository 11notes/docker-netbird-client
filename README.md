...
services:
  client:
    image: "11notes/netbird-client:0.68.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.68.3](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.68.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.68.3
docker pull ghcr.io/11notes/netbird-client:0.68.3
docker pull quay.io/11notes/netbird-client:0.68.3
```
...
*created 15.04.2026, 09:02:54 (CET)*