...
services:
  client:
    image: "11notes/netbird-client:0.65.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.65.3](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.65.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.65.3
docker pull ghcr.io/11notes/netbird-client:0.65.3
docker pull quay.io/11notes/netbird-client:0.65.3
```
...
*created 21.02.2026, 06:50:46 (CET)*