...
services:
  client:
    image: "11notes/netbird-client:0.63.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.63.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.63.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.63.0
docker pull ghcr.io/11notes/netbird-client:0.63.0
docker pull quay.io/11notes/netbird-client:0.63.0
```
...
*created 17.01.2026, 06:28:36 (CET)*