...
services:
  client:
    image: "11notes/netbird-client:0.64.6"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.64.6](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.64.6)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.64.6
docker pull ghcr.io/11notes/netbird-client:0.64.6
docker pull quay.io/11notes/netbird-client:0.64.6
```
...
*created 13.02.2026, 07:07:06 (CET)*