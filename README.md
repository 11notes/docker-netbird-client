...
services:
  client:
    image: "11notes/netbird-client:0.73.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.73.1](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.73.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.73.1
docker pull ghcr.io/11notes/netbird-client:0.73.1
docker pull quay.io/11notes/netbird-client:0.73.1
```
...
*created 20.06.2026, 10:27:58 (CET)*