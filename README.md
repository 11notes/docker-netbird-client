...
services:
  client:
    image: "11notes/netbird-client:0.64.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.64.3](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.64.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.64.3
docker pull ghcr.io/11notes/netbird-client:0.64.3
docker pull quay.io/11notes/netbird-client:0.64.3
```
...
*created 30.01.2026, 06:54:48 (CET)*