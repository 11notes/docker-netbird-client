...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-client | 30MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
...
services:
  client:
    image: "11notes/netbird-client:0.59.13"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.59.13](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.59.13)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.59.13
docker pull ghcr.io/11notes/netbird-client:0.59.13
docker pull quay.io/11notes/netbird-client:0.59.13
```
...
*created 15.11.2025, 02:50:56 (CET)*