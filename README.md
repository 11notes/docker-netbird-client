...
services:
  client:
    image: "11notes/netbird-client:0.79.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.79.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.79.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.79.0
docker pull ghcr.io/11notes/netbird-client:0.79.0
docker pull quay.io/11notes/netbird-client:0.79.0
```
...
*created 19.09.2026, 06:10:42 (CET)*