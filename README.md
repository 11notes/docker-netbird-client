...
services:
  client:
    image: "11notes/netbird-client:0.74.7"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.74.7](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.74.7)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.74.7
docker pull ghcr.io/11notes/netbird-client:0.74.7
docker pull quay.io/11notes/netbird-client:0.74.7
```
...
*created 18.07.2026, 09:06:07 (CET)*