...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-client | 39MB | 0:0 | ❌ | amd64, arm64, armv7 |
| netbirdio/netbird | 58MB | 0:0 | ❌ | amd64, arm64, armv6 |
...
services:
  client:
    image: "11notes/netbird-client:0.78.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
      NETBIRD_PEER_NAME: "${NETBIRD_PEER_NAME}"
...
* [0.78.1](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.78.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.78.1
docker pull ghcr.io/11notes/netbird-client:0.78.1
docker pull quay.io/11notes/netbird-client:0.78.1
```
...
*created 05.09.2026, 06:05:52 (CET)*