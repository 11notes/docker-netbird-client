...
services:
  client:
    image: "11notes/netbird-client:0.61.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.61.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.61.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.61.0
docker pull ghcr.io/11notes/netbird-client:0.61.0
docker pull quay.io/11notes/netbird-client:0.61.0
```
...
*created 30.12.2025, 06:32:35 (CET)*