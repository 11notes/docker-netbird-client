...
services:
  client:
    image: "11notes/netbird-client:0.62.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.62.3](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.62.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.62.3
docker pull ghcr.io/11notes/netbird-client:0.62.3
docker pull quay.io/11notes/netbird-client:0.62.3
```
...
*created 13.01.2026, 06:35:00 (CET)*