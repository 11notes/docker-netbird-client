...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-client | 38MB | 0:0 | ❌ | amd64, arm64, armv7 |
| netbirdio/netbird | 57MB | 0:0 | ❌ | amd64, arm64, armv6 |
...
services:
  client:
    image: "11notes/netbird-client:0.77.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.77.1](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.77.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.77.1
docker pull ghcr.io/11notes/netbird-client:0.77.1
docker pull quay.io/11notes/netbird-client:0.77.1
```
...
*created 22.08.2026, 06:04:57 (CET)*