...
services:
  client:
    image: "11notes/netbird-client:0.71.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.71.2](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.71.2)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.71.2
docker pull ghcr.io/11notes/netbird-client:0.71.2
docker pull quay.io/11notes/netbird-client:0.71.2
```
...
*created 17.05.2026, 09:38:45 (CET)*