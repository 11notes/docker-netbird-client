...
services:
  client:
    image: "11notes/netbird-client:0.60.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.60.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.60.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.60.0
docker pull ghcr.io/11notes/netbird-client:0.60.0
docker pull quay.io/11notes/netbird-client:0.60.0
```
...
*created 19.11.2025, 13:52:31 (CET)*