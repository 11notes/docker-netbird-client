...
services:
  client:
    image: "11notes/netbird-client:0.67.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.67.4](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.67.4)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.67.4
docker pull ghcr.io/11notes/netbird-client:0.67.4
docker pull quay.io/11notes/netbird-client:0.67.4
```
...
*created 06.04.2026, 09:01:19 (CET)*