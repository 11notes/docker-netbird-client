...
services:
  client:
    image: "11notes/netbird-client:0.67.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.67.3](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.67.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.67.3
docker pull ghcr.io/11notes/netbird-client:0.67.3
docker pull quay.io/11notes/netbird-client:0.67.3
```
...
*created 03.04.2026, 08:22:27 (CET)*