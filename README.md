...
services:
  client:
    image: "11notes/netbird-client:0.67.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.67.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.67.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.67.0
docker pull ghcr.io/11notes/netbird-client:0.67.0
docker pull quay.io/11notes/netbird-client:0.67.0
```
...
*created 24.03.2026, 07:07:07 (CET)*