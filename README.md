...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-client | 37MB | 0:0 | ❌ | amd64, arm64, armv7 |
...
services:
  client:
    image: "11notes/netbird-client:0.77.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.77.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.77.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.77.0
docker pull ghcr.io/11notes/netbird-client:0.77.0
docker pull quay.io/11notes/netbird-client:0.77.0
```
...
*created 17.08.2026, 10:21:54 (CET)*