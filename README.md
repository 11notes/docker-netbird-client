...
services:
  client:
    image: "11notes/netbird-client:0.64.5"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.64.5](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.64.5)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.64.5
docker pull ghcr.io/11notes/netbird-client:0.64.5
docker pull quay.io/11notes/netbird-client:0.64.5
```
...
*created 05.02.2026, 14:48:23 (CET)*