...
services:
  client:
    image: "11notes/netbird-client:0.66.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.66.3](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.66.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.66.3
docker pull ghcr.io/11notes/netbird-client:0.66.3
docker pull quay.io/11notes/netbird-client:0.66.3
```
...
*created 10.03.2026, 06:53:38 (CET)*