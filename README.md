...
| netbirdio/netbird | 55MB | 0:0 | ❌ | amd64, arm64, armv7 |
...
services:
  client:
    image: "11notes/netbird-client:0.72.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.72.4](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.72.4)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.72.4
docker pull ghcr.io/11notes/netbird-client:0.72.4
docker pull quay.io/11notes/netbird-client:0.72.4
```
...
*created 13.06.2026, 10:28:23 (CET)*