...
services:
  client:
    image: "11notes/netbird-client:0.67.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.67.2](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.67.2)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.67.2
docker pull ghcr.io/11notes/netbird-client:0.67.2
docker pull quay.io/11notes/netbird-client:0.67.2
```
...
*created 02.04.2026, 08:19:36 (CET)*