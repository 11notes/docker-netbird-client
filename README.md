...
services:
  client:
    image: "11notes/netbird-client:0.62.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.62.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.62.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.62.0
docker pull ghcr.io/11notes/netbird-client:0.62.0
docker pull quay.io/11notes/netbird-client:0.62.0
```
...
*created 08.01.2026, 06:35:03 (CET)*