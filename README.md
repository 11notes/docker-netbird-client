...
services:
  client:
    image: "11notes/netbird-client:0.67.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.67.1](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.67.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.67.1
docker pull ghcr.io/11notes/netbird-client:0.67.1
docker pull quay.io/11notes/netbird-client:0.67.1
```
...
*created 27.03.2026, 07:22:04 (CET)*