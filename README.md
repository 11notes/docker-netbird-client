...
services:
  client:
    image: "11notes/netbird-client:0.62.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.62.2](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.62.2)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.62.2
docker pull ghcr.io/11notes/netbird-client:0.62.2
docker pull quay.io/11notes/netbird-client:0.62.2
```
...
*created 10.01.2026, 06:31:24 (CET)*