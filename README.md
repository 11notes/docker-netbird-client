...
services:
  client:
    image: "11notes/netbird-client:0.75.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.75.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.75.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.75.0
docker pull ghcr.io/11notes/netbird-client:0.75.0
docker pull quay.io/11notes/netbird-client:0.75.0
```
...
*created 24.07.2026, 09:38:55 (CET)*