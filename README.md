...
services:
  client:
    image: "11notes/netbird-client:0.64.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.64.1](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.64.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.64.1
docker pull ghcr.io/11notes/netbird-client:0.64.1
docker pull quay.io/11notes/netbird-client:0.64.1
```
...
*created 24.01.2026, 06:30:34 (CET)*