...
services:
  client:
    image: "11notes/netbird-client:0.74.5"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.74.5](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.74.5)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.74.5
docker pull ghcr.io/11notes/netbird-client:0.74.5
docker pull quay.io/11notes/netbird-client:0.74.5
```
...
*created 15.07.2026, 09:21:43 (CET)*