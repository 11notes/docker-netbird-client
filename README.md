...
services:
  client:
    image: "11notes/netbird-client:0.66.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.66.4](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.66.4)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.66.4
docker pull ghcr.io/11notes/netbird-client:0.66.4
docker pull quay.io/11notes/netbird-client:0.66.4
```
...
*created 12.03.2026, 06:59:36 (CET)*