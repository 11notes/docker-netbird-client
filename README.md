...
services:
  client:
    image: "11notes/netbird-client:0.71.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.71.4](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.71.4)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.71.4
docker pull ghcr.io/11notes/netbird-client:0.71.4
docker pull quay.io/11notes/netbird-client:0.71.4
```
...
*created 22.05.2026, 10:27:36 (CET)*