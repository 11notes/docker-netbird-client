...
services:
  client:
    image: "11notes/netbird-client:0.65.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.65.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.65.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.65.0
docker pull ghcr.io/11notes/netbird-client:0.65.0
docker pull quay.io/11notes/netbird-client:0.65.0
```
...
*created 14.02.2026, 06:54:05 (CET)*