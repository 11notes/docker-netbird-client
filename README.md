...
services:
  client:
    image: "11notes/netbird-client:0.76.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.76.1](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.76.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.76.1
docker pull ghcr.io/11notes/netbird-client:0.76.1
docker pull quay.io/11notes/netbird-client:0.76.1
```
...
*created 03.08.2026, 10:38:43 (CET)*