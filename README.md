...
services:
  client:
    image: "11notes/netbird-client:0.64.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.64.0](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.64.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.64.0
docker pull ghcr.io/11notes/netbird-client:0.64.0
docker pull quay.io/11notes/netbird-client:0.64.0
```
...
*created 21.01.2026, 06:36:16 (CET)*