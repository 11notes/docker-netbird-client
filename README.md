...
services:
  client:
    image: "11notes/netbird-client:0.76.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.76.3](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.76.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.76.3
docker pull ghcr.io/11notes/netbird-client:0.76.3
docker pull quay.io/11notes/netbird-client:0.76.3
```
...
*created 09.08.2026, 07:52:51 (CET)*