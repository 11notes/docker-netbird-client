...
services:
  client:
    image: "11notes/netbird-client:0.78.2"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.78.2](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.78.2)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.78.2
docker pull ghcr.io/11notes/netbird-client:0.78.2
docker pull quay.io/11notes/netbird-client:0.78.2
```
...
*created 15.09.2026, 06:05:16 (CET)*