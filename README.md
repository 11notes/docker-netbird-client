...
| netbirdio/netbird | 51MB | 0:0 | ❌ | amd64, arm64, armv7 |
...
services:
  client:
    image: "11notes/netbird-client:0.62.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.62.1](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.62.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.62.1
docker pull ghcr.io/11notes/netbird-client:0.62.1
docker pull quay.io/11notes/netbird-client:0.62.1
```
...
*created 09.01.2026, 06:35:17 (CET)*