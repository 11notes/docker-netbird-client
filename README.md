...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-client | 34MB | 0:0 | ❌ | amd64, arm64, armv7 |
| netbirdio/netbird | 56MB | 0:0 | ❌ | amd64, arm64, armv6 |
...
services:
  client:
    image: "11notes/netbird-client:0.75.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
*created 29.07.2026, 09:49:56 (CET)*