...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/netbird-client:0.59.12 | 30MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
...
services:
  client:
    image: "11notes/netbird-client:0.59.12"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.59.12](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.59.12)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.59.12
docker pull ghcr.io/11notes/netbird-client:0.59.12
docker pull quay.io/11notes/netbird-client:0.59.12
```
...
*created 06.11.2025, 06:31:00 (CET)*