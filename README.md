...
services:
  client:
    image: "11notes/netbird-client:0.60.3"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.60.3](https://hub.docker.com/r/11notes/netbird-client/tags?name=0.60.3)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird-client:0.60.3
docker pull ghcr.io/11notes/netbird-client:0.60.3
docker pull quay.io/11notes/netbird-client:0.60.3
```
...
*created 27.11.2025, 11:27:18 (CET)*